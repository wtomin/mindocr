...
class TestConverterCOCOFORMAT(unittest.TestCase):
    ...
    def _test_format_det_label(self):
        ...
        with open(output_file, 'r') as f:
            contents = f.read()
        expected_contents = ('0060001.jpg\t[{"transcription": "口口口口", "points": [[218, 406], [356, 406], [356, 453], [218, 453]], "beziers": [219.0, 406.0, 264.33, 407.0, 309.67, 408.0, 355.0, 409.0, 352.0, 448.0, 307.33, 449.33, 262.67, 450.67, 218.0, 452.0]}]\n' 
                             '0060002.jpg\t[{"transcription": "口口口口口口口口", "points": [[335, 81], [587, 81], [587, 191], [335, 191]], "beziers": [341.0, 81.0, 422.67, 98.33, 504.33, 115.67, 586.0, 133.0, 582.0, 190.0, 499.67, 172.67, 417.33, 155.33, 335.0, 138.0]}, {"transcription": "4", "points": [[69, 182], [86, 182], [86, 201], [69, 201]], "beziers": [70.0, 183.0, 75.0, 182.67, 80.0, 182.33, 85.0, 182.0, 84.0, 199.0, 79.0, 199.33, 74.0, 199.67, 69.0, 200.0]}]\n')
        self.assertEqual(contents, expected_contents)
